...
module Zui
  ...
  COMPONENTS = {
    ...
    tap_area: [%i[enabled accepted_buttons gesture_policy long_press_threshold width height visible], %i[tap double_tap long_press press release cancel], true],
    point_handler: [%i[enabled accepted_buttons accepted_devices margin width height visible], %i[point active_change cancel], true],
    multi_touch_area: [%i[enabled minimum_touch_points maximum_touch_points mouse_enabled width height visible], %i[press update release cancel gesture], true],
    wheel_area: [%i[enabled accepted_devices blocking width height visible], %i[wheel active_change], true],
    safe_area: [%i[edges padding background width height visible], %i[change click], true],
    ...
    capture_session: [%i[camera_active camera_enabled audio_input_enabled audio_input_device audio_output_device video_output_enabled width height visible], %i[ready error], true],
    ...
    virtual_keyboard: [%i[active external_language_switch width y z visible], %i[active_change language_switch error], false],
    handwriting_input: [%i[input_panel available active width height z visible], %i[available_change active_change enabled_change error], false],
    keyboard_context: [%i[command text key modifiers command_revision extra_dictionaries watch visible], %i[change locale_change key error], false],
    keyboard_settings: [%i[style locale active_locales full_screen_mode user_data_path handwriting_disabled default_input_method_disabled default_dictionary_disabled close_on_return refresh_revision visible], %i[change error], false],
    keyboard_text_field: [%i[text placeholder enter_key enter_key_label enter_key_enabled input_method_hints extra_dictionaries width height enabled visible], %i[input change accept key error], false],
    clipboard: [%i[text watch revision visible], %i[change copied], false],
    bluetooth_permission: [%i[communication_modes auto_request request_revision visible], %i[change granted denied error], false],
    calendar_permission: [%i[access_mode auto_request request_revision visible], %i[change granted denied error], false],
    camera_permission: [%i[auto_request request_revision visible], %i[change granted denied error], false],
    contacts_permission: [%i[access_mode auto_request request_revision visible], %i[change granted denied error], false],
    location_permission: [%i[availability accuracy auto_request request_revision visible], %i[change granted denied error], false],
    microphone_permission: [%i[auto_request request_revision visible], %i[change granted denied error], false],
    ...
    ir_proximity_sensor: [%i[active always_on data_rate skip_duplicates axes_orientation_mode user_orientation refresh_revision visible], %i[reading active_change busy_change error], false],
    lid_sensor: [%i[active always_on data_rate skip_duplicates axes_orientation_mode user_orientation refresh_revision visible], %i[reading active_change busy_change error], false],
    ...
    tap_sensor: [%i[active always_on data_rate skip_duplicates axes_orientation_mode user_orientation return_double_tap_events refresh_revision visible], %i[reading active_change busy_change error], false],
    ...
    map_copyright: [%i[style_sheet width height visible], %i[link error], false],
    geo_json_data: [%i[source model command command_path command_revision visible], %i[change saved error], false],
    ...
    place_search: [%i[plugin plugin_parameters term search_area limit recommendation_id relevance visibility incremental command command_revision visible], %i[results status error], false],
    place_suggestions: [%i[plugin plugin_parameters term search_area limit command command_revision visible], %i[suggestions status error], false],
    place_categories: [%i[plugin plugin_parameters hierarchical command command_revision visible], %i[categories status error], false],
    place_details: [%i[plugin plugin_parameters place_id name latitude longitude altitude attribution visibility command command_revision visible], %i[details status saved removed error], false],
    place_category: [%i[plugin plugin_parameters category_id name visibility command command_revision visible], %i[details status saved removed error], false],
